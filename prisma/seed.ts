...
async function seedDatabase() {
  ...
  const players_s50 = [
      ...
      {name : "Rizo", tribe: "Vatu", season: 50, points: 141, eliminated: false},
      ...
      {name : "Aubry", tribe: "Vatu", season: 50, points: 147, eliminated: false},
      {name : "Joe", tribe: "Cila", season: 50, points: 160, eliminated: false},
      ...
      {name : "Cirie", tribe: "Cila", season: 50, points: 150, eliminated: false},
      ...
      {name : "Rick", tribe: "Cila", season: 50, points: 166, eliminated: false},
      {name : "Jenna", tribe: "Cila", season: 50, points: 4, eliminated: true}, //OUT
      {name : "Jonathan", tribe: "Kalo", season: 50, points: 172, eliminated: false},
      ...
      {name : "Tiffany", tribe: "Kalo", season: 50, points: 167, eliminated: false},
  ...
  const pointsData50 = [
    ...
    { playerId: players50.find(p => p.playerName === "Rizo" && p.season === 50)!.playerId, playerName: "Rizo", season: 50, points: [17, 0, 0, 0, 0, 36, 0, 4, 0] },
    ...
    { playerId: players50.find(p => p.playerName === "Aubry" && p.season === 50)!.playerId, playerName: "Aubry", season: 50, points: [17, 0, 1, 0, 0, 32, 0, 5, 0] },
    { playerId: players50.find(p => p.playerName === "Joe" && p.season === 50)!.playerId, playerName: "Joe", season: 50, points: [17, 0, 0, 0, 2, 25, 2, 3, 1] },
    ...
    { playerId: players50.find(p => p.playerName === "Cirie" && p.season === 50)!.playerId , playerName:"Cirie", season: 50, points: [17, 0, 1, 0, 0, 45, 0, 2, 1] },
    ...
    { playerId: players50.find(p => p.playerName === "Rick" && p.season === 50)!.playerId, playerName:"Rick", season: 50, points: [17, 1, 2, 0, 1, 46, 0, 2, 1] },
    ...
    { playerId: players50.find(p => p.playerName === "Jonathan" && p.season === 50)!.playerId , playerName:"Jonathan", season: 50, points:[17, 0, 1, 0, 1, 42, 1, 4, 1] },
    ...
    { playerId: players50.find(p => p.playerName === "Tiffany" && p.season === 50)!.playerId , playerName:"Tiffany", season: 50, points: [17, 0, 0, 0, 2, 22, 2, 5, 1] },
